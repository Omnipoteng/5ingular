          ...
          {steps.map((step, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative flex flex-col gap-5 p-7 bg-zinc-50 border border-zinc-100 rounded-2xl hover:border-blue-100 hover:bg-blue-50/30 transition-all"
              >
                <div className="flex items-center justify-between">
                  <div className="w-11 h-11 rounded-xl bg-white border border-zinc-200 flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600 transition-all shadow-sm">
                    <Icon size={20} />
                  </div>
                  <span className="text-2xl font-bold text-zinc-100 group-hover:text-blue-100 transition-colors select-none">
                    {step.num}
                  </span>
                </div>
