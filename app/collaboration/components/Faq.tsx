          ...
          {faqs.map((faq, idx) => (
            ...
            >
              ...
              >
                ...
                <span
                  className={`flex-shrink-0 w-7 h-7 rounded-full border border-zinc-200 flex items-center justify-center text-zinc-500 transition-all duration-300 ${
              ...
              <AnimatePresence initial={false}>
                {openIdx === idx && (
                  ...
                  >
                    <p className="px-6 pb-5 text-sm text-zinc-500 font-light leading-relaxed border-t border-zinc-100 pt-4">
                      {faq.a}
                    </p>
                  </motion.div>
                )}
