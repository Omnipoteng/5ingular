...
export default function AgentPortfolio({ portfolio }: AgentPortfolioProps) {
  ...
  return (
    <section className="py-24 bg-white dark:bg-zinc-950 border-b border-zinc-100 dark:border-zinc-800">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {portfolio.map((project, idx) => (
            ...
            >
              {/* Image Frame */}
              <div className="relative aspect-[16/10] rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 shadow-sm transition-all duration-300">
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
              ...
              <div className="flex items-start justify-between px-2">
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-zinc-400 dark:text-zinc-500 font-bold tracking-wider uppercase mt-1">
                    {project.category} &bull; {project.year}
                  </span>
                </div>
                <div className="w-8 h-8 rounded-full border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 group-hover:text-white group-hover:bg-blue-600 group-hover:border-blue-600 transition-all">
      ...
      <AnimatePresence>
        {selectedProject && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/70 backdrop-blur-md p-4 sm:p-6"
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-2xl max-w-3xl w-full max-h-[90vh] flex flex-col"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Modal Banner */}
              <div className="relative aspect-[16/9] w-full bg-zinc-50 dark:bg-zinc-800 border-b border-zinc-100 dark:border-zinc-800">
                <Image
              ...
              <div className="p-6 sm:p-8 overflow-y-auto flex flex-col gap-5">
                ...
                <div className="p-4 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 text-xs text-zinc-400 dark:text-zinc-500 font-light mt-2">
